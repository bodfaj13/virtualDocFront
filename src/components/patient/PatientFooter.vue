      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="" @click="logOut" data-dismiss="modal">Logout</a>
          </div>
        </div>
      </div>
    </div>
...
export default {
  name: 'PatientFooter',
  data: () => ({
    msg: 'Welcome to PatientFooter Component!',
    copyrightText: 'Copyright © Aboyeji Joshua 2018'
  }),
  methods: {
    logOut (e) {
      e.preventDefault()
